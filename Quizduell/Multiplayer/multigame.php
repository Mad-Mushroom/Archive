<html>
    ...
    <p id="PointsText"><?php
            ...
            if(--$questionIndex == $totalQuestions){
                header("Location: multisuccess.php?points=$points&id=$id&roomcode=$roomcode&playerNum=$playerNum&new=true");
            }
        ...
        <script>
            function answer1Clicked(){
                window.location.href = "multigame.php?ans1Press=true&points=" + <?php Print($points); ?> + "&questionIndex=" + <?php Print($questionIndex); ?> + "&quizFile=" + String("<?php Print($requestedQuiz); ?>") + "&id=" + String("<?php Print($id); ?>") + "&roomcode=" + String("<?php Print($roomcode); ?>") + "&playerNum=" + String("<?php Print($playerNum); ?>");
            }
            function answer2Clicked(){
                window.location.href = "multigame.php?ans2Press=true&points=" + <?php Print($points); ?> + "&questionIndex=" + <?php Print($questionIndex); ?> + "&quizFile=" + String("<?php Print($requestedQuiz); ?>") + "&id=" + String("<?php Print($id); ?>") + "&roomcode=" + String("<?php Print($roomcode); ?>") + "&playerNum=" + String("<?php Print($playerNum); ?>");;
            }
            function answer3Clicked(){
                window.location.href = "multigame.php?ans3Press=true&points=" + <?php Print($points); ?> + "&questionIndex=" + <?php Print($questionIndex); ?> + "&quizFile=" + String("<?php Print($requestedQuiz); ?>") + "&id=" + String("<?php Print($id); ?>") + "&roomcode=" + String("<?php Print($roomcode); ?>") + "&playerNum=" + String("<?php Print($playerNum); ?>");;
            }
            function answer4Clicked(){
                window.location.href = "multigame.php?ans4Press=true&points=" + <?php Print($points); ?> + "&questionIndex=" + <?php Print($questionIndex); ?> + "&quizFile=" + String("<?php Print($requestedQuiz); ?>") + "&id=" + String("<?php Print($id); ?>") + "&roomcode=" + String("<?php Print($roomcode); ?>") + "&playerNum=" + String("<?php Print($playerNum); ?>");;
            }
        </script>
        ...
        <?php
            function ansPress($clickedBtn){
                ...
                if($ansNumArr[$questionIndex] == $clickedBtn){
                    header("Location: multigame.php?points=". ++$points. "&questionIndex=" . ++$questionIndex . "&quizFile=" . $requestedQuiz . "&id=" . $id . "&roomcode=" . $roomcode . "&playerNum=" . $playerNum);
                    exit;
                }
                if($ansNumArr[$questionIndex] != $clickedBtn){
                    header("Location: multigame.php?points=" . $points . "&questionIndex=" . ++$questionIndex . "&quizFile=" . $requestedQuiz . "&id=" . $id . "&roomcode=" . $roomcode . "&playerNum=" . $playerNum);    
